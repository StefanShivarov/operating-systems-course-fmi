...
awk '{if($1 == "Array"){ arr = $2 }} {if($1 == "physicaldrive"){ drive = $2 }} {if($1 == "Current" && $2 == "Temperature"){ currtemp = $4 }} {if($1 == "Maximum" && $2 == "Temperature"){ maxtemp = $4; printf("%s-%s %d %d\n", arr, drive, currtemp, maxtemp) }}' ~/ssa-input.txt
